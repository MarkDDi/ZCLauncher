...
abstract public class LauncerUpdateDialog {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (appEntityReceiver.get_apk().equals(myiconInfo.get_apk())) {
                ...
                if ("com.hiveview.appstore.download_progress".equals(action)) {
                    ...
                    Toast toast = Toast.makeText(context, R.string.app_install_success, Toast.LENGTH_SHORT);
                    ...
                    Editor editor = mContext.getSharedPreferences(Launcher.PREFERENCE_WINSIDE_SETTING, Context.MODE_PRIVATE).edit();
                    editor.putString(Launcher.WINSIDE_LAUNCHER_VERSION, appEntityReceiver.get_version());
                    editor.commit();
                ...
                if ("com.hiveview.appstore.download_busy".equals(action)) {
                    Toast toast = Toast.makeText(context, R.string.download_busy, Toast.LENGTH_SHORT);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
    ...
    public LauncerUpdateDialog(Context context, IconsEntity iconInfo, String type) {
    ...
    public void show() {
        ...
        mContext.registerReceiver(this.appBroadcastReceiver, intentFilter);
    ...
    private void dialogInit(Window window) {
        ...
        appTypeStr = mContext.getResources().getString(R.string.update_time);
        ...
        descriptionStr = mContext.getResources().getString(R.string.update_detail_intro_info);
        ...
        StringBuffer des = new StringBuffer(String.format(descriptionStr, myiconInfo.get_description()));
        des.append("\n提示：Launcher更新后会重新启动，期间会出现短暂黑屏，属于正常现象！");
        ...
        app_detail_icon.setImageResource(R.drawable.ic_launcher);
