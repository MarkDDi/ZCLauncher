...
public class MatrixAppView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixAppView.inflate(this.getContext(), R.layout.matrix_app_view, null), new RelativeLayout.LayoutParams(
        ...
        this.flippers = new ViewFlipper[]{this.app_flipper_0, this.app_flipper_1, this
                .app_flipper_2, this.app_flipper_3, this.app_flipper_4, this.app_flipper_5};        
        this.appLayouts = new View[]{this.matrix_app_layout_0, this.matrix_app_layout_1, this.matrix_app_layout_2, 
                this.matrix_app_layout_3, this.matrix_app_layout_4, this.matrix_app_layout_5};
...
public void setMatrixData(boolean isRefleshData) {
    ...
    for(v2 = 0; v2 < v0; ++v2) {
        ...
        public void doOnClick(View view) {
            ...
            else if(MatrixAppView.this.flippers[indet].getCurrentView() != null && MatrixAppView.this
