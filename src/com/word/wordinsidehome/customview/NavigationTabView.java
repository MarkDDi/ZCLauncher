...
public class NavigationTabView extends RelativeLayout {
    ...
    private void init() {
        ...
        this.gameGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.gameTextView, 
                "scaleX", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.gameTextView, 
                "scaleY", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.gameFadeView, 
                "alpha", new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.gameLostFocusAnimSet = new AnimatorSet();
        this.gameLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.gameTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.gameTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.gameFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.healthGetFocusAnimSet = new AnimatorSet();
        this.healthGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.healthTextView, 
                "scaleX", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.healthTextView, 
                "scaleY", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.healthFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.healthLostFocusAnimSet = new AnimatorSet();
        this.healthLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.healthTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.healthTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.healthFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
                
        this.movieGetFocusAnimSet = new AnimatorSet();
        this.movieGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.movieTextView, 
                "scaleX", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.movieTextView, 
                "scaleY", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.movieFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.movieLostFocusAnimSet = new AnimatorSet();
        this.movieLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.movieTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.movieTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.movieFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.educationGetFocusAnimSet = new AnimatorSet();
        this.educationGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.educationTextView, "scaleX", 
                new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.educationTextView, "scaleY", 
                new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.educationFadeView, "alpha", new 
                float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.educationLostFocusAnimSet = new AnimatorSet();
        this.educationLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.educationTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.educationTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.educationFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.recomendGetFocusAnimSet = new AnimatorSet();
        this.recomendGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.recommendTextView, 
                "scaleX", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.recommendTextView, 
                "scaleY", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.recommendFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.recomendLostFocusAnimSet = new AnimatorSet();
        this.recomendLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.recommendTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.recommendTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.recommendFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.appGetFocusAnimSet = new AnimatorSet();
        this.appGetFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.appTextView, 
                "scaleX", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.appTextView, 
                "scaleY", new float[]{1.0f,1.2f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.appFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.appLostFocusAnimSet = new AnimatorSet();
        this.appLostFocusAnimSet.playTogether(new Animator[]{ObjectAnimator.ofFloat(this.appTextView, 
                "scaleX", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.appTextView, 
                "scaleY", new float[]{1.2f,1.0f}).setDuration(DURATION), ObjectAnimator.ofFloat(this.appFadeView, 
                "alpha",  new float[]{1.0f,0.6f,1.0f}).setDuration(DURATION)});
        this.gameTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)NavigationTabView.this.gameTextView
                            .getTag()).intValue());
                }
                else {
        ...
        this.healthTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)NavigationTabView.this.healthTextView
                            .getTag()).intValue());
                }
                else {
        ...
        this.educationTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)NavigationTabView.this.educationTextView
                            .getTag()).intValue());
                }
                else {
        ...
        this.recommendTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)NavigationTabView.this.recommendTextView
                            .getTag()).intValue());
                }
                else {
        ...
        this.movieTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)(NavigationTabView.this.movieTextView
                            .getTag())).intValue());
                }
                else {
        ...
        this.appTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean focused) {
                if(focused) {
                    ...
                    NavigationTabView.this.tabChangeListener.onScrollStart(((Integer)NavigationTabView.this.appTextView
                            .getTag()).intValue());
                }
                else {
    ...
    public void scrollCursor(int preIndex, int currentIndex, int pageCount) {
        ...
        if(v1 != 0) {
            ...
            if(currentIndex == pageCount - 1 && preIndex == 0) {
                ...
                this.cursorImageViewAnimator = ObjectAnimator.ofFloat(v2, "translationX", v4).setDuration(
                        v10);
