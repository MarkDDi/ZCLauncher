...
public class MatrixRecommendView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixRecommendView.inflate(this.getContext(), R.layout.matrix_recommend_view, null), new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
        ...
        this.flippers = new ViewFlipper[]{this.recommend_flipper_0, this.recommend_flipper_1, this.recommend_flipper_2, this.recommend_flipper_3, recommend_flipper_4, recommend_flipper_5, recommend_flipper_6};

        this.recommendLayouts = new View[]{this.matrix_recommend_layout_0, this.matrix_recommend_layout_1, this.matrix_recommend_layout_2, this.matrix_recommend_layout_3, this.matrix_recommend_layout_4, this.matrix_recommend_layout_5, this.matrix_recommend_layout_6};
    ...
    public void doOnClick(View view) {
        ...
        } else if (MatrixRecommendView.this.flippers[indet].getCurrentView() != null && MatrixRecommendView.this.flippers[indet].getChildCount() != 0) {
        ...
        new MyDialog(mContext, iconInfo, "推荐") {
            ...
            public void onSetPositiveButton() {
                if (!NetworkUtils.isNetAvailable(mContext)) {
                    ...
                    Toast toast = Toast.makeText(mContext, R.string.error_net, Toast.LENGTH_SHORT);
