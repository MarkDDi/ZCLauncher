...
public class MatrixEducationView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixEducationView.inflate(this.getContext(), R.layout.matrix_education_view, null), new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
        ...
        this.flippers = new ViewFlipper[]{this.education_flipper_0, this.education_flipper_1, this.education_flipper_2, this.education_flipper_3, education_flipper_4, education_flipper_5, education_flipper_6, education_flipper_7};
        this.educationLayouts = new View[]{this.matrix_education_layout_0, this.matrix_education_layout_1, this.matrix_education_layout_2, this.matrix_education_layout_3, this.matrix_education_layout_4, this.matrix_education_layout_5, this.matrix_education_layout_6, this.matrix_education_layout_7};
    ...
    public void doOnClick(View view) {
        ...
        } else if (MatrixEducationView.this.flippers[indet].getCurrentView() != null && MatrixEducationView.this.flippers[indet].getChildCount() != 0) {
