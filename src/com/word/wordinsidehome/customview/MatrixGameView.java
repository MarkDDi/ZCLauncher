...
public class MatrixGameView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixGameView.inflate(this.getContext(), R.layout.matrix_game_view, null), new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.FILL_PARENT, RelativeLayout.LayoutParams.FILL_PARENT));
        ...
        this.flippers = new ViewFlipper[]{this.game_flipper_0, this.game_flipper_1, this.game_flipper_2, this.game_flipper_3, game_flipper_4, game_flipper_5, game_flipper_6};

        this.gameLayouts = new View[]{this.matrix_game_layout_0, this.matrix_game_layout_1, this.matrix_game_layout_2, this.matrix_game_layout_3, this.matrix_game_layout_4, this.matrix_game_layout_5, this.matrix_game_layout_6};
    ...
    public void doOnClick(View view) {
        ...
        } else if (MatrixGameView.this.flippers[indet].getCurrentView() != null && MatrixGameView.this.flippers[indet].getChildCount() != 0) {
