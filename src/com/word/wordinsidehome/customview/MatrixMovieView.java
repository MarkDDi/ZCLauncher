...
public class MatrixMovieView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixMovieView.inflate(this.getContext(), R.layout.matrix_movie_view, null), new RelativeLayout.LayoutParams(
        ...
        this.movieLayouts = new View[]{this.matrix_movie_layout_0, this.matrix_movie_layout_1, this.matrix_movie_layout_2, 
                this.matrix_movie_layout_3, this.matrix_movie_layout_4,this.matrix_movie_layout_5, this.matrix_movie_layout_6, this.matrix_movie_layout_7};
...
public void setMatrixData(boolean isRefleshData) {
    ...
    for(v2 = 0; v2 < v0; ++v2) {
        ...
        public void doOnClick(View view) {
            ...
            else if(MatrixMovieView.this.flippers[indet].getCurrentView() != null && MatrixMovieView.this
