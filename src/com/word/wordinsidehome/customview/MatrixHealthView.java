...
public class MatrixHealthView extends TabBasePageView {
    ...
    protected void init() {
        ...
        this.addView(MatrixHealthView.inflate(this.getContext(), R.layout.matrix_health_view, null), new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
        ...
        this.flippers = new ViewFlipper[]{this.health_flipper_0, this.health_flipper_1, this.health_flipper_2, this.health_flipper_3, health_flipper_4, health_flipper_5, health_flipper_6, health_flipper_7};
        this.healthLayouts = new View[]{this.matrix_health_layout_0, this.matrix_health_layout_1, this.matrix_health_layout_2, this.matrix_health_layout_3, this.matrix_health_layout_4, this.matrix_health_layout_5, this.matrix_health_layout_6, this.matrix_health_layout_7};
    ...
    public void doOnClick(View view) {
        ...
        } else if (MatrixHealthView.this.flippers[indet].getCurrentView() != null && MatrixHealthView.this.flippers[indet].getChildCount() != 0) {
