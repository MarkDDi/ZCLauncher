...
public class HealthDAO extends BaseDAO {
    ...
    public synchronized void delete(String where, String[] selectionArgs) {
        ...
        try {
            this.context.getContentResolver().delete(HealthDAO.URI_HEALTH, where, selectionArgs);
            return;
    ...
    public void insert(IconsEntity iconsEntity) {
        ...
        resolver.insert(HealthDAO.URI_HEALTH, cv);                       
    }
    public void insert(WordinsideBaseEntity wdBaseEntity) {
    	  ArrayList iconsEntityArrayList = ((HealthEntity)wdBaseEntity).get_iconsEntity();
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(HealthDAO.URI_HEALTH, selections, 
    ...
    public synchronized ArrayList queryMatrixHealth(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
