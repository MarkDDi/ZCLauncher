...
public class AppDAO extends BaseDAO {
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(AppDAO.URI_APP, selections, 
    ...
    public synchronized ArrayList queryMatrixApp(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
