...
public class GameDAO extends BaseDAO {
    ...
    public synchronized void delete(String where, String[] selectionArgs) {
        ...
        try {
            this.context.getContentResolver().delete(GameDAO.URI_GAME, where, selectionArgs);
            return;
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(GameDAO.URI_GAME, selections, 
    ...
    public synchronized ArrayList queryMatrixGame(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
