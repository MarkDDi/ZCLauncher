...
public class RecommendDAO extends BaseDAO {
    ...
    public synchronized void delete(String where, String[] selectionArgs) {
        ...
        try {
            this.context.getContentResolver().delete(RecommendDAO.URI_RECOMMEND, where, selectionArgs);
            return;
    ...
    public void insert(IconsEntity iconsEntity) {
        ...
        resolver.insert(RecommendDAO.URI_RECOMMEND, cv);                       
    }
    public void insert(WordinsideBaseEntity wdBaseEntity) {
    	  ArrayList iconsEntityArrayList = ((RecommendEntity)wdBaseEntity).get_iconsEntity();
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(RecommendDAO.URI_RECOMMEND, selections, 
    ...
    public synchronized ArrayList queryMatrixRecommend(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
