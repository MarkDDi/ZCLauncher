...
public abstract class BaseDAO {
    ...
    static {
        URI_HEALTH = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_HEALTH").toString());
        URI_GAME = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_GAME").toString());
        URI_RECOMMEND = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_RECOMMEND").toString());
        URI_EDUCATION = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_EDUCATION").toString());
        URI_MOVIE = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_MOVIE").toString());
        URI_APP = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_APP").toString());
        URI_LAUNCHER = Uri.parse(new StringBuffer().append("content://").append("WordinsideAuthorities").append('/').append("TABLE_LAUNCHER").toString());
