...
public class MovieDAO extends BaseDAO {
    ...
    public synchronized void delete(String where, String[] selectionArgs) {
        ...
        try {
            this.context.getContentResolver().delete(MovieDAO.URI_MOVIE, where, selectionArgs);
            return;
    ...
    public void insert(IconsEntity iconsEntity) {
        ...
        resolver.insert(MovieDAO.URI_MOVIE, cv);                       
    }
    public void insert(WordinsideBaseEntity wdBaseEntity) {
    	  ArrayList iconsEntityArrayList = ((MovieEntity)wdBaseEntity).get_iconsEntity();
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(MovieDAO.URI_MOVIE, selections, 
    ...
    public synchronized ArrayList queryMatrixMovie(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
