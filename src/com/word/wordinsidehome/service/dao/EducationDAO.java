...
public class EducationDAO extends BaseDAO {
    ...
    public synchronized void delete(String where, String[] selectionArgs) {
        ...
        try {
            this.context.getContentResolver().delete(EducationDAO.URI_EDUCATION, where, selectionArgs);
            return;
    ...
    public void insert(IconsEntity iconsEntity) {
        ...
        resolver.insert(EducationDAO.URI_EDUCATION, cv);                       
    }
    public void insert(WordinsideBaseEntity wdBaseEntity) {
    	  ArrayList iconsEntityArrayList = ((EducationEntity)wdBaseEntity).get_iconsEntity();
    ...
    public synchronized ArrayList query(String[] selections, String where, String[] selectionArgs, String sortOrder) {
        Cursor c = this.context.getContentResolver().query(EducationDAO.URI_EDUCATION, selections, 
    ...
    public synchronized ArrayList queryMatrixEducation(String[] selections, String where, String[] selectionArgs, String 
            sortOrder) {
